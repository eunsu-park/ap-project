...
def weighted_original(base_config, input_day, output_day, epoch, overwrite=False):
...
def weighted_subsample(base_config, input_day, output_day, epoch, subsample_index, overwrite=False):
