...
def main(config) -> Dict[str, Any]:
    ...
    validation_cosine_sims = []  # NEW: Track feature alignment
    all_targets = []
    all_predictions = []
    all_probabilities = []
    ...
    for i, data_dict in enumerate(validation_dataloader):
        try:
            ...
            probabilities = validation_dict['probabilities'][0]
    ...
    results = {
        ...
        'average_cosine_sim': avg_cosine_sim,  # NEW
        'std_cosine_sim': std_cosine_sim,  # NEW
