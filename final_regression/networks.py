...
def create_model(config, logger=None):
    ...
    message = f"Enhanced MultiModalModel (Regression) with Transformer, ConvLSTM, and CrossModalFusion created. Output shape: (batch, {num_target_groups}, {num_target_variables})"
